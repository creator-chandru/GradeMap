    ...
    return (
        <header className = "flex flex-col justify-center items-center h-screen ">
            ...
            <div className = "p-5">
                ...
                <button className = "bg-blue-500 px-15 py-2 block m-auto mt-4 text-2xl font-bold rounded-lg hover:bg-sky-900 cursor-pointer" onClick = {()=>{document.getElementById('subject-form').scrollIntoView({ behavior: 'smooth' })}}>Begin</button>
            </div>
        </header>
    );
