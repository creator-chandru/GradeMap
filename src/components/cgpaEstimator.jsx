export function CgpaEstimator(props){
    return (
        <div className="mt-8 rounded-3xl border border-amber-400/20 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 p-8 text-center shadow-xl shadow-slate-950/40">
