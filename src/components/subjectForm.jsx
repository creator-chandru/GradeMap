    ...
    return (
        <section id="subject-form" className = "bg-slate-900/60 border border-slate-700/50 rounded-2xl p-5 w-full max-w-sm mx-auto md:max-w-xl md:p-8 md:ml-8 backdrop-blur-md shadow-xl shadow-slate-950/40">
            <form action = {handleFormSubject} className = "flex flex-col gap-4">
                ...
                <button type = "submit" className = "mt-2 rounded-xl bg-gradient-to-r from-amber-400 to-yellow-500 px-6 py-3 text-sm md:text-base font-bold text-slate-950 shadow-lg shadow-amber-500/20 transition-all duration-300 hover:scale-[1.02] hover:from-amber-300 hover:to-yellow-400 active:scale-95 cursor-pointer"> + Add Subject</button>
            </form>
